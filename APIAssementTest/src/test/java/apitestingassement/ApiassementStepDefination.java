...
public class ApiassementStepDefination {
	...
	// Scenario 2: Various Status Codes and Status Field Returned by API
	...
	// Scenario 3: Verification of API Response time is not less than 3 seconds
	...
	// Scenario 4: Validation of USD to AED Exchange Rate Range
	...
	// Scenario 5:Verification of Currency Pairs Returned
...
// Scenario 6: Validate JSON Schema
	...
	{
		// execute before the assertion step.
	}

	
	 @Then("the API response should match the JSON schema") public void the_api_response_should_match_the_json_schema()
	 { // This step will execute after the validation step.
		 
	 
	  response.then().assertThat().body(JsonSchemaValidator.matchesJsonSchemaInClasspath( "C:\\Users\\shree\\Downloads\\APITesting\\src\\test\\Resource\\TestData\\schema.json"));
